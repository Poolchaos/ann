    ...
    return [
      ...
      },
      {
        ...
        moduleId: PLATFORM.moduleName(
          "features/journalist/articles/create-article/create-article"
        ),
        nav: true,
  ...
  private static defaultUserRoutes(): RouteConfig[] {
    return [
      ...
      },
      {
        ...
        name: "purchases",
        moduleId: PLATFORM.moduleName(
          "features/default_user/purchases/purchases"
        ),
        nav: true,
        title: "Purchases",
        auth: true,
      ...
      },
      {
        ...
        moduleId: PLATFORM.moduleName(
          "features/default_user/cart/checkout-complete/checkout-complete"
        ),
        nav: true,
